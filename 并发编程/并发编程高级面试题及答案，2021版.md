...
### [4、请说出与线程同步以及线程调度相关的方法。](https://gitlab.gaorta.com/devteam/learning-journey/study-materials-collection/-/tree/master/docs/并发编程/并发编程高级面试题及答案，2021版.md#4请说出与线程同步以及线程调度相关的方法。)
