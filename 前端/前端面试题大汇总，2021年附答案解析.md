...
### [8、介绍一下你对浏览器内核的理解？](https://gitlab.gaorta.com/devteam/learning-journey/study-materials-collection/-/tree/master/docs/前端/前端面试题大汇总，2021年附答案解析.md#8介绍一下你对浏览器内核的理解)
